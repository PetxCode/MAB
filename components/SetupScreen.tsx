           ...
           <div className="bg-white rounded-xl p-4 shadow-md border border-slate-200 flex items-center justify-between">
             <div className="flex items-center gap-3">
               ...
               <div>
                 ...
                 <p className="text-slate-900 font-semibold">{activeSessionLabel}</p>
               </div>
             </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
        ...
        <div className="bg-slate-50 px-8 py-6 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <span className="text-emerald-600 text-xs font-bold tracking-widest uppercase mb-1 block">Course Configuration</span>
              <h1 className="text-xl md:text-2xl font-bold text-slate-900 leading-none">{course.title}</h1>
            </div>
          </div>
          <div className="hidden md:block text-right">
             <span className="text-4xl font-black text-slate-100">{course.code.split(' ')[1]}</span>
          </div>
        </div>
        ...
        <div className="p-8 space-y-8">
          <div className="grid gap-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                >
                  <option value="" disabled>Choose a learning module...</option>
                  {modules.map(m => (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                >
                  <option value="" disabled>Choose a specific session...</option>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-5 rounded-xl border border-slate-200 flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-slate-800 text-sm mb-1">Exam Parameters</h3>
              <p className="text-xs text-slate-500 leading-relaxed">
                You will be tested on <strong className="text-slate-700">20 random questions</strong> from a pool of 50.
                <br />
                Time limit is set strictly to <strong className="text-slate-700">8 minutes</strong>.
              </p>
            </div>
          </div>
          ...
          <Button 
            ...
            size="lg" 
            variant="primary"
            onClick={() => selectedModule && onStart(selectedModule.title, selectedSession)}
            disabled={!canStart}
